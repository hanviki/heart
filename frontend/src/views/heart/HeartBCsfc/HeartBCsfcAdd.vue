...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setFields () {
                let values = this.form.getFieldsValue([  'id'     ,  'username'     ,  'fileNo'     ,  'name'     ,  'fileName'     ,  'fileUrl'     ,  'avr'     ,  'mvr'     ,  'sbydycwz'     ,  'xbjy'     ,  'ef'     ,  'zsszwnj'     ,  'zdmbhzj'     ,  'zdmdzj'     ,  'sdmdzj'     ,  'szdmdzj'     ,  'csjcsj'     ,  'isDeletemark'     ,  'createTime'     ,  'modifyTime'     ,  'createUserId'     ,  'modifyUserId'   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.heartBCsfc[_key] = values[_key] })
                }
            }
        }
    }
