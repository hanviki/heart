  ...
  >
    ...
    >
      ...
      >
        ...
        <checkSix-info ref="checkSixInfo"></checkSix-info>
      </a-tab-pane>
      <a-tab-pane
        key="4"
        tab="超声"
...
import CheckSixInfo from '../HeartBChecksix/HeartBChecksixListInfo' // 检验 6
import CsInfo from '../HeartBCs/HeartBCsListInfo' // 超声
import CtInfo from '../HeartBCt/HeartBCtListInfo' // 术前CT
import OutInfo from '../HeartBCtout/OutListInfo' // 出院复查CT
