<template>
    <a-drawer
        ...
        <a-form :form="form">
                ...
                <a-form-item v-bind="formItemLayout"
                    label="区">
                        <a-input placeholder="请输入区" v-decorator="['area', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="详细地址">
                ...
                <a-form-item v-bind="formItemLayout"
                    label="联系方式">
                        <a-input placeholder="请输入联系方式" v-decorator="['telphone', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="入诊日期和时间">
                        <a-date-picker showTime format='YYYY-MM-DD HH:mm:ss' v-decorator="[ 'inCheck', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="发病-就诊时间">
                        <a-input placeholder="请输入发病-就诊时间" v-decorator="['toCheck', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="疼痛部位">
                        <a-input placeholder="请输入疼痛部位" v-decorator="['painPos', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="症状和体征">
                        <a-input placeholder="请输入症状和体征" v-decorator="['symptoms', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="症状和体征">
                        <a-input placeholder="请输入症状和体征" v-decorator="['otherSymptoms', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="急诊转归">
                        <a-input placeholder="请输入急诊转归" v-decorator="['emergency', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="死亡原因">
                        <a-input placeholder="请输入死亡原因" v-decorator="['deathCause', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="死亡时间">
                ...
                <a-form-item v-bind="formItemLayout"
                    label="急诊转归备注">
                        <a-input placeholder="请输入急诊转归备注" v-decorator="['emergencyNote', {}]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="是否删除">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setFields () {
                let values = this.form.getFieldsValue([  'id'     ,  'username'     ,  'fileNo'     ,  'name'     ,  'age'     ,  'gender'     ,  'height'     ,  'weight'     ,  'province'     ,  'city'     ,  'area'     ,  'address'     ,  'telphone'     ,  'inCheck'     ,  'toCheck'     ,  'painPos'     ,  'symptoms'     ,  'otherSymptoms'     ,  'emergency'     ,  'deathCause'     ,  'deathDate'     ,  'emergencyNote'     ,  'isDeletemark'     ,  'createTime'     ,  'modifyTime'     ,  'createUserId'     ,  'modifyUserId'   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.heartBPatientinfo[_key] = values[_key] })
                }
            }
        }
    }
