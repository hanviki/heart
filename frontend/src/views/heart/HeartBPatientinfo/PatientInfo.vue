...
export default {
  ...
  methods: {
    ...
    // this.user.roleName
    // this.user.username
      this.form.getFieldDecorator('createname')
      this.form.setFieldsValue({ createname: user.realname })
    },
    setFields () {
      let values = this.form.getFieldsValue(['createname', 'fileNo', 'name', 'age', 'gender', 'height', 'weight', 'province', 'city', 'area', 'address', 'telphone', 'inCheck', 'zhusu', 'toYear', 'toMonth', 'toDay', 'toHour', 'painPos', 'symptoms', 'otherSymptoms', 'emergency', 'deathCause', 'deathDate', 'emergencyNote'])
