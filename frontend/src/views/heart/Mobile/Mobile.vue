...
import Regist from '../HeartBPatientinfo/AddInfo'
import Modify from '../HeartBPatientinfo/List'
...
<style lang="less" scoped>
  .container {
    ...
    height: 100vh;
    overflow: auto;
    background: #f0f2f5   center 110px;
    background-size: 100%;
    .content {
      padding: 32px 0;
      flex: 1;
